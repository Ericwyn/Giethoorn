...
//    }
     ...
     *
     * 队列先塞进去 1，此时队列如右边                  | 1 |
     * 然后队列非空，就吧 1 的左右子树塞进去           | 1 | 2 | 3 |
     * 然后拿出来 1 ，因为这个时候 1 已经利用完毕，我们已经知道他的左右子树了而且也塞入队列了
     *
     * 然后这个时候队列如右边                          | 2 | 3 |
     * 会发现这就是第二层了
     * 那么第三成呢，4，5，6，7 四个数字，刚好就是 2 的左子树，右子树，3 的左子树，右子树
     *
     * 所以当然是先把 2 的左子树右子树都塞进来，变成    | 2 | 3 | 4 | 5 |
     * 然后同理， 2 已经利用完毕了我们已经知道他的下一层了
     * 所以 2 呢出队列
     *
     * 以此类推
     *
